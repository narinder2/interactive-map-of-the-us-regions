...
function free_usa_map_plugin_license_link(){
    $file   = basename( __FILE__ );
    $folder = basename( dirname( __FILE__ ) );
    add_action( "after_plugin_row_{$folder}/{$file}", 'free_usa_map_plugin_license_link_show');
}
add_action('admin_init','free_usa_map_plugin_license_link');

function free_usa_map_plugin_license_link_show( $plugin_name ) {
        
    echo '</tr><tr class="plugin-update-tr"><td colspan="3" class="plugin-update"><div class="update-message" style="margin:5px;">This plugin is deprecated. Please use our new, free <a href="/wp-admin/plugin-install.php?tab=plugin-information&#038;plugin=html5-maps&#038;TB_iframe=true&#038;width=600&#038;height=550" class="thickbox" aria-label="More information about HTML5 Maps 1.4" data-title="HTML5 Maps 1.4">HTML5 map</a> plugin instead. It includes a responsive mobile-friendly map of the United States.</div></td>';
